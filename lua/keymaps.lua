...
-- Mimic VsCode Alt + ArrowUp/ArrowDown
...
vim.keymap.set("n", "<leader>r", [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]], { desc = 'Replace all under cursor' })
...
-- Override TreeSitter::EditQuery to Netrw
